...
public class AuthorsTab extends EntryEditorTab {
    ...
    private StackPane getRelatedArticlesPane(BibEntry entry) {
        ...
        root.getChildren().add(getRelatedArticleInfo(entry));
       ...
       /**MrDLibFetcher fetcher = new MrDLibFetcher(preferencesService.getLanguage().name(),
        ...
        BackgroundTask
                ...
                .onSuccess(relatedArticles -> {
                    ...
                    root.getChildren().add(getRelatedArticleInfo(entry, fetcher));
                })
                .onFailure(exception -> {
     ...
     *
     * @param entry List of BibEntries of related articles
     * @return VBox of related article descriptions to be displayed in the Related Articles tab
     */
    private ScrollPane getRelatedArticleInfo(BibEntry entry) {
    ...
    private ScrollPane getPrivacyDialog(BibEntry entry) {
        ...
        Text title = new Text(Localization.lang("Author1"));
        ...
        Text title2 = new Text(Localization.lang("Author2"));
